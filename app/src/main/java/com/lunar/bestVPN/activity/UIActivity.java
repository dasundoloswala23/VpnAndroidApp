package com.lunar.bestVPN.activity;
...
import com.lunar.bestVPN.Config;
import com.lunar.bestVPN.MainApplication;
import com.lunar.bestVPN.adapter.PrefManager;
import com.lunar.bestVPN.fragments.ServersFragment;
import com.lunar.bestVPN.utils.Converter;
...
import static com.lunar.bestVPN.Config.servers_subscription;
...
public abstract class UIActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
   ...
   private final Handler handler = new Handler();
    ...
    private void loadRewardedAd() {
        ...
        RewardedAd.load(this,"ca-app-pub-1757670602701937/4021761676",
                ...
                public void success(@NonNull Boolean aBoolean) {
                    ...
                    if (aBoolean) {
                        ...
                        new MaterialDialog.Builder(UIActivity.this)
                                .title("Confirmation")
                                .message("Are You Sure to Disconnect The BestVPN")
